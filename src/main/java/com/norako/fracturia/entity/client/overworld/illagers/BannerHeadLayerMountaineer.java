...
public class BannerHeadLayerMountaineer extends GeoRenderLayer<MountaineerEntity>
{
    public BannerHeadLayerMountaineer(GeoRenderer<MountaineerEntity> entityRenderer)
    {
        super(entityRenderer);
    }

    @Override
    public void render(MatrixStack poseStack, MountaineerEntity animatable, BakedGeoModel bakedModel,
