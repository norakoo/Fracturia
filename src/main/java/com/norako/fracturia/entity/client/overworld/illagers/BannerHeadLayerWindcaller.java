...
public class BannerHeadLayerWindcaller extends GeoRenderLayer<WindcallerEntity>
{
    public BannerHeadLayerWindcaller(GeoRenderer<WindcallerEntity> entityRenderer)
    {
        super(entityRenderer);
    }

    @Override
    public void render(MatrixStack poseStack, WindcallerEntity animatable, BakedGeoModel bakedModel,
