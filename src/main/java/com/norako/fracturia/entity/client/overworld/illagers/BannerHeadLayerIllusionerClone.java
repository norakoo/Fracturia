...
public class BannerHeadLayerIllusionerClone extends GeoRenderLayer<IllusionerCloneEntity>
{
    public BannerHeadLayerIllusionerClone(GeoRenderer<IllusionerCloneEntity> entityRenderer)
    {
        super(entityRenderer);
    }

    @Override
    public void render(MatrixStack poseStack, IllusionerCloneEntity animatable, BakedGeoModel bakedModel,
