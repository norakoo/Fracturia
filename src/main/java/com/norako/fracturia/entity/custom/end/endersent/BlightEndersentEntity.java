...
public class BlightEndersentEntity extends EndersentEntity {

    public BlightEndersentEntity(EntityType<? extends BlightEndersentEntity> type, World world) {
        super(type, world);
    }

    @Override
    public EndersentWorldState.Variant getVariant() {
        return EndersentWorldState.Variant.BLIGHT;
    }
    ...
    @Override
    protected String getBossBarName() { return "§aBlight Endersent"; }
